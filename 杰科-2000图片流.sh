...
" >10.txt
if curl --header "session_id: 127096891@wuhanshizhedt_1563622360" -d '@10.txt'  http://100.119.30.20:11180/business/api/condition/query_camera |grep "OK" &>/dev/null ;then echo $line >> ipzz.txt;fi
...
wait 
#最终比对合适的摄像头id
diff -c {21这台机子的摄像头的id列表文件} ipzz.txt | egrep '^[-!] [0-9]{1,}' | egrep -o "[0-9]{1,}" >合适摄像头id文件
